...
/**
 * Clase que encuentra la raíz de una función entre dos puntos (a, b) mediante el metodo de Regla Falsa.
 */
public class ReglaFalsa
{
     ...
     */
    public ReglaFalsa(double a, double b, double ep, Expression f)
    {
        this.a = a;
        this.b = b;
        this.ep = ep;
    ...
    /**
     * Metodo que genera el valor de Xr con el metodo de Regla Falsa.
    ...
    /**
     * Metodo que realiza el algoritmo de Regla Falsa:
     *      1. Se calcula el Xr
